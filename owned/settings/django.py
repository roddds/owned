...
ALLOWED_HOSTS = ['localhost', 'ec2.deodoro.org']
...
STATIC_ROOT = os.path.abspath(os.path.join(ABSOLUTE_PROJECT_ROOT, 'static_root/'))
...
SECRET_KEY = 'qkqy!!q(fv(_($oi41xm#fr^5u^1&a-uk6l@m4nkq-al)ql0#y'
