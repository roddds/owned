...
urlpatterns = patterns('',
    ...
    url(r'^password/alterar/$', auth_views.password_change, name='auth_password_change'),
    url(r'^password/alterar/done/$', auth_views.password_change_done, name='auth_password_change_done'),
